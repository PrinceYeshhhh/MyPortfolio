          ...
          <div className="lg:w-1/3">
            <div className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl">
              ...
              <div className="mt-8 pt-8 border-t border-gray-200 dark:border-gray-700">
                <h4 className="text-lg font-bold mb-4 text-gray-900 dark:text-white">Connect with me</h4>
                <div className="flex space-x-4">
                  <a href="#" className="bg-gray-200 dark:bg-gray-700 p-3 rounded-full text-gray-600 dark:text-gray-300 hover:bg-blue-600 hover:text-white transition-colors">
          ...
          <div className="lg:w-2/3">
            <form onSubmit={handleSubmit} className="bg-gray-50 dark:bg-gray-800 p-8 rounded-xl">
              ...
              <button
                ...
                className={`bg-blue-600 hover:bg-blue-700 text-white px-6 py-3 rounded-md transition-colors flex items-center justify-center ${
